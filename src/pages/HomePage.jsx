                ...
                <div>
                    <section class="text-gray-600 body-font">
                        <div class="container px-5 py-24 mx-auto">
                            ...
                            <p class="leading-relaxed text-lg">Man needs difficulties in life because they are necessary to enjoy success.</p>
                            <span class="inline-block h-1 w-10 rounded bg-green-800 mt-8 mb-6"></span>
                            <h2 class="text-gray-900 font-medium title-font tracking-wider text-sm">Dr A. P. J. Abdul Kalam</h2>
                            {/* <p class="text-gray-800">Senior Product Designer</p> */}
                            </div>
                        </div>
                    </section>
                </div>
